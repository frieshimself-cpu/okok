 ...
 *
 * The mining loop needs a *synchronous* hash so it can grind nonces tightly;
 * WebCrypto's digest is async-only, so we implement the compression function
 * by hand. Zero dependencies, identical output in Node and the browser.
